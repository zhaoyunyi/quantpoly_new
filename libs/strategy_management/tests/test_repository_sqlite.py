...
def test_sqlite_repository_persists_strategy_state_across_restart(tmp_path):
    ...
    service1 = StrategyService(repository=repo1, count_active_backtests=lambda user_id, strategy_id: 0)
    ...
    service2 = StrategyService(repository=repo2, count_active_backtests=lambda user_id, strategy_id: 0)
